...
| `PUT`    | `/api/users/approve`                          | Approve a student. Body: `userId`, `managerId`.                                                                           |
...
| Method | Path                   | Description                                                                                                      |
| ------ | ---------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `POST` | `/api/webhooks/stripe` | Stripe webhook. Validates Stripe signature; handles subscription and invoice events. **Not protected by Clerk.** |
