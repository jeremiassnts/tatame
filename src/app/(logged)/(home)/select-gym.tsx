import { useAssociateGym } from "@/src/api/gyms/associate-gym";
import { useListGyms } from "@/src/api/gyms/list-gyms";
...
export default function SelectGym() {
  const { data: gyms, isLoading: isLoadingGyms } = useListGyms();
